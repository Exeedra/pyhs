...
def get_delivery_buttons():
    ...
    keyboard.add(InlineKeyboardButton(text='Курьером', callback_data='courier'))
    return keyboard.as_markup()


def get_payment_buttons():
    keyboard = InlineKeyboardBuilder()
    keyboard.add(InlineKeyboardButton(text='При получении', callback_data='cash'))
    keyboard.add(InlineKeyboardButton(text='Предоплата', callback_data='prepayment'))
    return keyboard.as_markup()
